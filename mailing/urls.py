...
from mailing.views import PartnerCreateView, ClientsListCreateView, mailing_panel, MailingCreateView, mailings_manage, \
    PartnerListView, MailingListView, MailingDetailView, toggle_block_status, toggle_block_partners, PartnersDetailView, \
    MailingPartnersListView, MailingPartnersDetailView, MailingPartnersUpdateView, MailingPartnersDeleteView
